...
#define GPIOA_PA8_OUT_6                       8U
#define GPIOA_PA9_OUT_7                       9U
#define GPIOA_PA10_OUT_8                      10U
#define GPIOA_PA11_USART6TX                   11U
#define GPIOA_PA12_USART6RX                   12U
#define GPIOA_PA13_SWDIO_CPU                  13U
#define GPIOA_PA14_SWCLK_CPU                  14U
#define GPIOA_PA15_NC                         15U
#define GPIOB_PB0_INPUT_1                     0U
#define GPIOB_PB1_INPUT_2                     1U
#define GPIOB_PB2_NC                          2U
#define GPIOB_PB3_NC                          3U
#define GPIOB_PB4_NC                          4U
#define GPIOB_PB5_NC                          5U
#define GPIOB_PB6_LED_RED                     6U
#define GPIOB_PB7_LED_GRN                     7U
#define GPIOB_PB8_MOTOR1_L1                   8U
#define GPIOB_PB9_MOTOR1_L2                   9U
#define GPIOB_PB10_OUT_1                      10U
#define GPIOB_PB11_NC                         11U
#define GPIOB_PB12_OUT_2                      12U
#define GPIOB_PB13_OUT_3                      13U
#define GPIOB_PB14_OUT_4                      14U
#define GPIOB_PB15_OUT_5                      15U
#define GPIOC_PC0_JUMP1                       0U
#define GPIOC_PC1_JUMP2                       1U
#define GPIOC_PC2_MOTOR2_L1                   2U
#define GPIOC_PC3_MOTOR2_L2                   3U
#define GPIOC_PC4_MOTOR2_H2                   4U
#define GPIOC_PC5_MOTOR2_H1                   5U
#define GPIOC_PC6_NC                          6U
#define GPIOC_PC7_NC                          7U
#define GPIOC_PC8_NC                          8U
#define GPIOC_PC9_NC                          9U
#define GPIOC_PC10_MOTOR1_H1                  10U
#define GPIOC_PC11_MOTOR1_H2                  11U
...
#define GPIOD_PD4_NC                          4U
#define GPIOD_PD5_NC                          5U
#define GPIOD_PD6_NC                          6U
#define GPIOD_PD7_NC                          7U
#define GPIOD_PD8_NC                          8U
#define GPIOD_PD9_NC                          9U
...
#define LINE_OUT_6                            PAL_LINE(GPIOA, 8U)
#define LINE_OUT_7                            PAL_LINE(GPIOA, 9U)
#define LINE_OUT_8                            PAL_LINE(GPIOA, 10U)
#define LINE_USART6TX                         PAL_LINE(GPIOA, 11U)
#define LINE_USART6RX                         PAL_LINE(GPIOA, 12U)
#define LINE_SWDIO_CPU                        PAL_LINE(GPIOA, 13U)
#define LINE_SWCLK_CPU                        PAL_LINE(GPIOA, 14U)
#define LINE_INPUT_1                          PAL_LINE(GPIOB, 0U)
#define LINE_INPUT_2                          PAL_LINE(GPIOB, 1U)
#define LINE_LED_RED                          PAL_LINE(GPIOB, 6U)
#define LINE_LED_GRN                          PAL_LINE(GPIOB, 7U)
#define LINE_MOTOR1_L1                        PAL_LINE(GPIOB, 8U)
#define LINE_MOTOR1_L2                        PAL_LINE(GPIOB, 9U)
#define LINE_OUT_1                            PAL_LINE(GPIOB, 10U)
#define LINE_OUT_2                            PAL_LINE(GPIOB, 12U)
#define LINE_OUT_3                            PAL_LINE(GPIOB, 13U)
#define LINE_OUT_4                            PAL_LINE(GPIOB, 14U)
#define LINE_OUT_5                            PAL_LINE(GPIOB, 15U)
#define LINE_JUMP1                            PAL_LINE(GPIOC, 0U)
#define LINE_JUMP2                            PAL_LINE(GPIOC, 1U)
#define LINE_MOTOR2_L1                        PAL_LINE(GPIOC, 2U)
#define LINE_MOTOR2_L2                        PAL_LINE(GPIOC, 3U)
#define LINE_MOTOR2_H2                        PAL_LINE(GPIOC, 4U)
#define LINE_MOTOR2_H1                        PAL_LINE(GPIOC, 5U)
#define LINE_MOTOR1_H1                        PAL_LINE(GPIOC, 10U)
#define LINE_MOTOR1_H2                        PAL_LINE(GPIOC, 11U)
...
#define VAL_GPIOA_MODER             (PIN_MODE_INPUT(GPIOA_PA0_NC) | \
                                     ...
                                     PIN_MODE_ALTERNATE(GPIOA_PA14_SWCLK_CPU) | \
                                     PIN_MODE_INPUT(GPIOA_PA15_NC))

/*
 * GPIO Port B Modes
 */
#define VAL_GPIOB_MODER             (PIN_MODE_INPUT(GPIOB_PB0_INPUT_1) | \
                                     PIN_MODE_INPUT(GPIOB_PB1_INPUT_2) | \
                                     PIN_MODE_INPUT(GPIOB_PB2_NC) | \
                                     PIN_MODE_INPUT(GPIOB_PB3_NC) | \
                                     PIN_MODE_INPUT(GPIOB_PB4_NC) | \
                                     PIN_MODE_INPUT(GPIOB_PB5_NC) | \
                                     PIN_MODE_OUTPUT(GPIOB_PB6_LED_RED) | \
                                     PIN_MODE_OUTPUT(GPIOB_PB7_LED_GRN) | \
                                     PIN_MODE_OUTPUT(GPIOB_PB8_MOTOR1_L1) | \
 ...
 * GPIO Port C Modes
 */
#define VAL_GPIOC_MODER             (PIN_MODE_INPUT(GPIOC_PC0_JUMP1) | \
                                     PIN_MODE_INPUT(GPIOC_PC1_JUMP2) | \
                                     PIN_MODE_OUTPUT(GPIOC_PC2_MOTOR2_L1) | \
                                     PIN_MODE_OUTPUT(GPIOC_PC3_MOTOR2_L2) | \
                                     PIN_MODE_ALTERNATE(GPIOC_PC4_MOTOR2_H2) | \
                                     PIN_MODE_ALTERNATE(GPIOC_PC5_MOTOR2_H1) | \
                                     PIN_MODE_INPUT(GPIOC_PC6_NC) | \
                                     PIN_MODE_INPUT(GPIOC_PC7_NC) | \
                                     PIN_MODE_INPUT(GPIOC_PC8_NC) | \
                                     PIN_MODE_INPUT(GPIOC_PC9_NC) | \
                                     PIN_MODE_ALTERNATE(GPIOC_PC10_MOTOR1_H1) | \
                                     PIN_MODE_ALTERNATE(GPIOC_PC11_MOTOR1_H2) | \
...
#define VAL_GPIOD_MODER             (PIN_MODE_INPUT(GPIOD_PD0_NC) | \
                                     ...
                                     PIN_MODE_INPUT(GPIOD_PD4_NC) | \
                                     PIN_MODE_INPUT(GPIOD_PD5_NC) | \
                                     PIN_MODE_INPUT(GPIOD_PD6_NC) | \
                                     PIN_MODE_INPUT(GPIOD_PD7_NC) | \
                                     PIN_MODE_INPUT(GPIOD_PD8_NC) | \
                                     PIN_MODE_INPUT(GPIOD_PD9_NC) | \
 ...
 * GPIO Port H Modes
 */
#define VAL_GPIOH_MODER             (PIN_MODE_INPUT(GPIOH_PH0_NC) | \
 ...
 */
#define VAL_GPIOA_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOA_PA0_NC) | \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOA_PA8_OUT_6) | \
                                     PIN_OTYPE_PUSHPULL(GPIOA_PA9_OUT_7) | \
                                     PIN_OTYPE_PUSHPULL(GPIOA_PA10_OUT_8) | \
                                     PIN_OTYPE_PUSHPULL(GPIOA_PA11_USART6TX) | \
                                     PIN_OTYPE_PUSHPULL(GPIOA_PA12_USART6RX) | \
                                     PIN_OTYPE_PUSHPULL(GPIOA_PA13_SWDIO_CPU) | \
                                     PIN_OTYPE_PUSHPULL(GPIOA_PA14_SWCLK_CPU) | \
                                     PIN_OTYPE_PUSHPULL(GPIOA_PA15_NC))

/*
 * GPIO Port B Output types
 */
#define VAL_GPIOB_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOB_PB0_INPUT_1) | \
                                     PIN_OTYPE_PUSHPULL(GPIOB_PB1_INPUT_2) | \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOB_PB6_LED_RED) | \
                                     PIN_OTYPE_PUSHPULL(GPIOB_PB7_LED_GRN) | \
                                     PIN_OTYPE_PUSHPULL(GPIOB_PB8_MOTOR1_L1) | \
                                     PIN_OTYPE_PUSHPULL(GPIOB_PB9_MOTOR1_L2) | \
                                     PIN_OTYPE_PUSHPULL(GPIOB_PB10_OUT_1) | \
                                     PIN_OTYPE_PUSHPULL(GPIOB_PB11_NC) | \
                                     PIN_OTYPE_PUSHPULL(GPIOB_PB12_OUT_2) | \
                                     PIN_OTYPE_PUSHPULL(GPIOB_PB13_OUT_3) | \
                                     PIN_OTYPE_PUSHPULL(GPIOB_PB14_OUT_4) | \
                                     PIN_OTYPE_PUSHPULL(GPIOB_PB15_OUT_5))

/*
 * GPIO Port C Output types
 */
#define VAL_GPIOC_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOC_PC0_JUMP1) | \
                                     PIN_OTYPE_PUSHPULL(GPIOC_PC1_JUMP2) | \
                                     PIN_OTYPE_PUSHPULL(GPIOC_PC2_MOTOR2_L1) | \
                                     PIN_OTYPE_PUSHPULL(GPIOC_PC3_MOTOR2_L2) | \
                                     PIN_OTYPE_PUSHPULL(GPIOC_PC4_MOTOR2_H2) | \
                                     PIN_OTYPE_PUSHPULL(GPIOC_PC5_MOTOR2_H1) | \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOC_PC10_MOTOR1_H1) | \
                                     PIN_OTYPE_PUSHPULL(GPIOC_PC11_MOTOR1_H2) | \
...
#define VAL_GPIOD_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOD_PD0_NC) | \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOD_PD4_NC) | \
                                     PIN_OTYPE_PUSHPULL(GPIOD_PD5_NC) | \
                                     PIN_OTYPE_PUSHPULL(GPIOD_PD6_NC) | \
                                     PIN_OTYPE_PUSHPULL(GPIOD_PD7_NC) | \
                                     PIN_OTYPE_PUSHPULL(GPIOD_PD8_NC) | \
                                     PIN_OTYPE_PUSHPULL(GPIOD_PD9_NC) | \
 ...
 */
#define VAL_GPIOH_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOH_PH0_NC) | \
 ...
 */
#define VAL_GPIOA_OSPEEDR           (PIN_OSPEED_LOW(GPIOA_PA0_NC) | \
                                     PIN_OSPEED_LOW(GPIOA_PA1_ACCLINKTXE) | \
                                     PIN_OSPEED_LOW(GPIOA_PA2_ACCLINKTX) | \
                                     PIN_OSPEED_LOW(GPIOA_PA3_ACCLINKRX) | \
                                     PIN_OSPEED_LOW(GPIOA_PA4_NC) | \
                                     PIN_OSPEED_LOW(GPIOA_PA5_NC) | \
                                     PIN_OSPEED_LOW(GPIOA_PA6_NC) | \
                                     PIN_OSPEED_LOW(GPIOA_PA7_NC) | \
                                     PIN_OSPEED_LOW(GPIOA_PA8_OUT_6) | \
                                     PIN_OSPEED_LOW(GPIOA_PA9_OUT_7) | \
                                     PIN_OSPEED_LOW(GPIOA_PA10_OUT_8) | \
                                     PIN_OSPEED_LOW(GPIOA_PA11_USART6TX) | \
                                     PIN_OSPEED_LOW(GPIOA_PA12_USART6RX) | \
                                     PIN_OSPEED_LOW(GPIOA_PA13_SWDIO_CPU) | \
                                     PIN_OSPEED_LOW(GPIOA_PA14_SWCLK_CPU) | \
                                     PIN_OSPEED_LOW(GPIOA_PA15_NC))

/*
 * GPIO Port B Output speeds
 */
#define VAL_GPIOB_OSPEEDR           (PIN_OSPEED_LOW(GPIOB_PB0_INPUT_1) | \
                                     PIN_OSPEED_LOW(GPIOB_PB1_INPUT_2) | \
                                     PIN_OSPEED_LOW(GPIOB_PB2_NC) | \
                                     PIN_OSPEED_LOW(GPIOB_PB3_NC) | \
                                     PIN_OSPEED_LOW(GPIOB_PB4_NC) | \
                                     PIN_OSPEED_LOW(GPIOB_PB5_NC) | \
                                     PIN_OSPEED_LOW(GPIOB_PB6_LED_RED) | \
                                     PIN_OSPEED_LOW(GPIOB_PB7_LED_GRN) | \
                                     PIN_OSPEED_LOW(GPIOB_PB8_MOTOR1_L1) | \
                                     PIN_OSPEED_LOW(GPIOB_PB9_MOTOR1_L2) | \
                                     PIN_OSPEED_LOW(GPIOB_PB10_OUT_1) | \
                                     PIN_OSPEED_LOW(GPIOB_PB11_NC) | \
                                     PIN_OSPEED_LOW(GPIOB_PB12_OUT_2) | \
                                     PIN_OSPEED_LOW(GPIOB_PB13_OUT_3) | \
                                     PIN_OSPEED_LOW(GPIOB_PB14_OUT_4) | \
                                     PIN_OSPEED_LOW(GPIOB_PB15_OUT_5))

/*
 * GPIO Port C Output speeds
 */
#define VAL_GPIOC_OSPEEDR           (PIN_OSPEED_LOW(GPIOC_PC0_JUMP1) | \
                                     PIN_OSPEED_LOW(GPIOC_PC1_JUMP2) | \
                                     PIN_OSPEED_LOW(GPIOC_PC2_MOTOR2_L1) | \
                                     PIN_OSPEED_LOW(GPIOC_PC3_MOTOR2_L2) | \
                                     PIN_OSPEED_LOW(GPIOC_PC4_MOTOR2_H2) | \
                                     PIN_OSPEED_LOW(GPIOC_PC5_MOTOR2_H1) | \
                                     PIN_OSPEED_LOW(GPIOC_PC6_NC) | \
                                     PIN_OSPEED_LOW(GPIOC_PC7_NC) | \
                                     PIN_OSPEED_LOW(GPIOC_PC8_NC) | \
                                     PIN_OSPEED_LOW(GPIOC_PC9_NC) | \
                                     PIN_OSPEED_LOW(GPIOC_PC10_MOTOR1_H1) | \
                                     PIN_OSPEED_LOW(GPIOC_PC11_MOTOR1_H2) | \
                                     PIN_OSPEED_LOW(GPIOC_PC12_NC) | \
                                     PIN_OSPEED_LOW(GPIOC_PC13_NC) | \
 ...
 */
#define VAL_GPIOD_OSPEEDR           (PIN_OSPEED_LOW(GPIOD_PD0_NC) | \
                                     PIN_OSPEED_LOW(GPIOD_PD1_NC) | \
                                     PIN_OSPEED_LOW(GPIOD_PD2_NC) | \
                                     PIN_OSPEED_LOW(GPIOD_PD3_NC) | \
                                     PIN_OSPEED_LOW(GPIOD_PD4_NC) | \
                                     PIN_OSPEED_LOW(GPIOD_PD5_NC) | \
                                     PIN_OSPEED_LOW(GPIOD_PD6_NC) | \
                                     PIN_OSPEED_LOW(GPIOD_PD7_NC) | \
                                     PIN_OSPEED_LOW(GPIOD_PD8_NC) | \
                                     PIN_OSPEED_LOW(GPIOD_PD9_NC) | \
                                     PIN_OSPEED_LOW(GPIOD_PD10_NC) | \
                                     PIN_OSPEED_LOW(GPIOD_PD11_NC) | \
                                     PIN_OSPEED_LOW(GPIOD_PD12_NC) | \
...
#define VAL_GPIOE_OSPEEDR           (PIN_OSPEED_LOW(GPIOE_PE0_NC) | \
                                     ...
                                     PIN_OSPEED_LOW(GPIOE_PE8_NC) | \
                                     PIN_OSPEED_LOW(GPIOE_PE9_NC) | \
                                     PIN_OSPEED_LOW(GPIOE_PE10_NC) | \
                                     PIN_OSPEED_LOW(GPIOE_PE11_NC) | \
                                     PIN_OSPEED_LOW(GPIOE_PE12_NC) | \
                                     PIN_OSPEED_LOW(GPIOE_PE13_NC) | \
                                     PIN_OSPEED_LOW(GPIOE_PE14_NC) | \
                                     PIN_OSPEED_LOW(GPIOE_PE15_NC))
 ...
 */
#define VAL_GPIOH_OSPEEDR           (PIN_OSPEED_LOW(GPIOH_PH0_NC) | \
 ...
 */
#define VAL_GPIOA_ODR               (PIN_ODR_HIGH(GPIOA_PA0_NC) | \
                                     ...
                                     PIN_ODR_LOW(GPIOA_PA8_OUT_6) | \
                                     PIN_ODR_LOW(GPIOA_PA9_OUT_7) | \
                                     PIN_ODR_LOW(GPIOA_PA10_OUT_8) | \
                                     PIN_ODR_HIGH(GPIOA_PA11_USART6TX) | \
                                     PIN_ODR_HIGH(GPIOA_PA12_USART6RX) | \
                                     PIN_ODR_HIGH(GPIOA_PA13_SWDIO_CPU) | \
                                     PIN_ODR_HIGH(GPIOA_PA14_SWCLK_CPU) | \
                                     PIN_ODR_HIGH(GPIOA_PA15_NC))

/*
 * GPIO Port B Output default values
 */
#define VAL_GPIOB_ODR               (PIN_ODR_HIGH(GPIOB_PB0_INPUT_1) | \
                                     PIN_ODR_HIGH(GPIOB_PB1_INPUT_2) | \
                                     PIN_ODR_HIGH(GPIOB_PB2_NC) | \
                                     PIN_ODR_HIGH(GPIOB_PB3_NC) | \
                                     PIN_ODR_HIGH(GPIOB_PB4_NC) | \
                                     PIN_ODR_HIGH(GPIOB_PB5_NC) | \
                                     PIN_ODR_HIGH(GPIOB_PB6_LED_RED) | \
                                     PIN_ODR_LOW(GPIOB_PB7_LED_GRN) | \
                                     PIN_ODR_LOW(GPIOB_PB8_MOTOR1_L1) | \
                                     PIN_ODR_LOW(GPIOB_PB9_MOTOR1_L2) | \
                                     PIN_ODR_LOW(GPIOB_PB10_OUT_1) | \
                                     PIN_ODR_HIGH(GPIOB_PB11_NC) | \
                                     PIN_ODR_LOW(GPIOB_PB12_OUT_2) | \
                                     PIN_ODR_LOW(GPIOB_PB13_OUT_3) | \
                                     PIN_ODR_LOW(GPIOB_PB14_OUT_4) | \
                                     PIN_ODR_LOW(GPIOB_PB15_OUT_5))

/*
 * GPIO Port C Output default values
 */
#define VAL_GPIOC_ODR               (PIN_ODR_HIGH(GPIOC_PC0_JUMP1) | \
                                     PIN_ODR_HIGH(GPIOC_PC1_JUMP2) | \
                                     PIN_ODR_LOW(GPIOC_PC2_MOTOR2_L1) | \
                                     PIN_ODR_LOW(GPIOC_PC3_MOTOR2_L2) | \
                                     PIN_ODR_LOW(GPIOC_PC4_MOTOR2_H2) | \
                                     PIN_ODR_LOW(GPIOC_PC5_MOTOR2_H1) | \
                                     PIN_ODR_HIGH(GPIOC_PC6_NC) | \
                                     PIN_ODR_HIGH(GPIOC_PC7_NC) | \
                                     PIN_ODR_HIGH(GPIOC_PC8_NC) | \
                                     PIN_ODR_HIGH(GPIOC_PC9_NC) | \
                                     PIN_ODR_LOW(GPIOC_PC10_MOTOR1_H1) | \
                                     PIN_ODR_LOW(GPIOC_PC11_MOTOR1_H2) | \
...
#define VAL_GPIOD_ODR               (PIN_ODR_HIGH(GPIOD_PD0_NC) | \
                                     ...
                                     PIN_ODR_HIGH(GPIOD_PD4_NC) | \
                                     PIN_ODR_HIGH(GPIOD_PD5_NC) | \
                                     PIN_ODR_HIGH(GPIOD_PD6_NC) | \
                                     PIN_ODR_HIGH(GPIOD_PD7_NC) | \
                                     PIN_ODR_HIGH(GPIOD_PD8_NC) | \
                                     PIN_ODR_HIGH(GPIOD_PD9_NC) | \
 ...
 */
#define VAL_GPIOH_ODR               (PIN_ODR_HIGH(GPIOH_PH0_NC) | \
 ...
 */
#define VAL_GPIOA_PUPDR             (PIN_PUPDR_PULLUP(GPIOA_PA0_NC) | \
                                     PIN_PUPDR_FLOATING(GPIOA_PA1_ACCLINKTXE) | \
                                     PIN_PUPDR_FLOATING(GPIOA_PA2_ACCLINKTX) | \
                                     ...
                                     PIN_PUPDR_FLOATING(GPIOA_PA8_OUT_6) | \
                                     PIN_PUPDR_FLOATING(GPIOA_PA9_OUT_7) | \
                                     PIN_PUPDR_FLOATING(GPIOA_PA10_OUT_8) | \
                                     PIN_PUPDR_FLOATING(GPIOA_PA11_USART6TX) | \
                                     PIN_PUPDR_PULLUP(GPIOA_PA12_USART6RX) | \
                                     PIN_PUPDR_PULLUP(GPIOA_PA13_SWDIO_CPU) | \
                                     PIN_PUPDR_PULLUP(GPIOA_PA14_SWCLK_CPU) | \
                                     PIN_PUPDR_PULLUP(GPIOA_PA15_NC))

/*
 * GPIO Port B Pullups and downs
 */
#define VAL_GPIOB_PUPDR             (PIN_PUPDR_FLOATING(GPIOB_PB0_INPUT_1) | \
                                     PIN_PUPDR_FLOATING(GPIOB_PB1_INPUT_2) | \
                                     PIN_PUPDR_PULLUP(GPIOB_PB2_NC) | \
                                     PIN_PUPDR_PULLUP(GPIOB_PB3_NC) | \
                                     PIN_PUPDR_PULLUP(GPIOB_PB4_NC) | \
                                     PIN_PUPDR_PULLUP(GPIOB_PB5_NC) | \
                                     PIN_PUPDR_FLOATING(GPIOB_PB6_LED_RED) | \
                                     PIN_PUPDR_FLOATING(GPIOB_PB7_LED_GRN) | \
                                     PIN_PUPDR_FLOATING(GPIOB_PB8_MOTOR1_L1) | \
                                     PIN_PUPDR_FLOATING(GPIOB_PB9_MOTOR1_L2) | \
                                     PIN_PUPDR_FLOATING(GPIOB_PB10_OUT_1) | \
                                     PIN_PUPDR_PULLUP(GPIOB_PB11_NC) | \
                                     PIN_PUPDR_FLOATING(GPIOB_PB12_OUT_2) | \
                                     PIN_PUPDR_FLOATING(GPIOB_PB13_OUT_3) | \
                                     PIN_PUPDR_FLOATING(GPIOB_PB14_OUT_4) | \
                                     PIN_PUPDR_FLOATING(GPIOB_PB15_OUT_5))

/*
 * GPIO Port C Pullups and downs
 */
#define VAL_GPIOC_PUPDR             (PIN_PUPDR_PULLUP(GPIOC_PC0_JUMP1) | \
                                     PIN_PUPDR_PULLUP(GPIOC_PC1_JUMP2) | \
                                     PIN_PUPDR_FLOATING(GPIOC_PC2_MOTOR2_L1) | \
                                     PIN_PUPDR_FLOATING(GPIOC_PC3_MOTOR2_L2) | \
                                     PIN_PUPDR_FLOATING(GPIOC_PC4_MOTOR2_H2) | \
                                     PIN_PUPDR_FLOATING(GPIOC_PC5_MOTOR2_H1) | \
                                     PIN_PUPDR_PULLUP(GPIOC_PC6_NC) | \
                                     PIN_PUPDR_PULLUP(GPIOC_PC7_NC) | \
                                     PIN_PUPDR_PULLUP(GPIOC_PC8_NC) | \
                                     PIN_PUPDR_PULLUP(GPIOC_PC9_NC) | \
                                     PIN_PUPDR_FLOATING(GPIOC_PC10_MOTOR1_H1) | \
                                     PIN_PUPDR_FLOATING(GPIOC_PC11_MOTOR1_H2) | \
...
#define VAL_GPIOD_PUPDR             (PIN_PUPDR_PULLUP(GPIOD_PD0_NC) | \
                                     ...
                                     PIN_PUPDR_PULLUP(GPIOD_PD4_NC) | \
                                     PIN_PUPDR_PULLUP(GPIOD_PD5_NC) | \
                                     PIN_PUPDR_PULLUP(GPIOD_PD6_NC) | \
                                     PIN_PUPDR_PULLUP(GPIOD_PD7_NC) | \
                                     PIN_PUPDR_PULLUP(GPIOD_PD8_NC) | \
                                     PIN_PUPDR_PULLUP(GPIOD_PD9_NC) | \
 ...
 */
#define VAL_GPIOH_PUPDR             (PIN_PUPDR_PULLUP(GPIOH_PH0_NC) | \
...
#define VAL_GPIOA_AFRL              (PIN_AFIO_AF_0(GPIOA_PA0_NC) | \
                                     PIN_AFIO_AF_0(GPIOA_PA1_ACCLINKTXE) | \
                                     PIN_AFIO_AF_7(GPIOA_PA2_ACCLINKTX) | \
                                     PIN_AFIO_AF_7(GPIOA_PA3_ACCLINKRX) | \
                                     PIN_AFIO_AF_0(GPIOA_PA4_NC) | \
...
#define VAL_GPIOA_AFRH              (PIN_AFIO_AF_1(GPIOA_PA8_OUT_6) | \
                                     ...
                                     PIN_AFIO_AF_0(GPIOA_PA14_SWCLK_CPU) | \
                                     PIN_AFIO_AF_0(GPIOA_PA15_NC))

/*
 * GPIO Port B Alternate functions
 */
#define VAL_GPIOB_AFRL              (PIN_AFIO_AF_0(GPIOB_PB0_INPUT_1) | \
                                     PIN_AFIO_AF_0(GPIOB_PB1_INPUT_2) | \
                                     PIN_AFIO_AF_0(GPIOB_PB2_NC) | \
                                     PIN_AFIO_AF_0(GPIOB_PB3_NC) | \
                                     PIN_AFIO_AF_0(GPIOB_PB4_NC) | \
                                     PIN_AFIO_AF_0(GPIOB_PB5_NC) | \
                                     PIN_AFIO_AF_0(GPIOB_PB6_LED_RED) | \
                                     PIN_AFIO_AF_0(GPIOB_PB7_LED_GRN))
#define VAL_GPIOB_AFRH              (PIN_AFIO_AF_0(GPIOB_PB8_MOTOR1_L1) | \
 ...
 */
#define VAL_GPIOC_AFRL              (PIN_AFIO_AF_0(GPIOC_PC0_JUMP1) | \
                                     PIN_AFIO_AF_0(GPIOC_PC1_JUMP2) | \
                                     PIN_AFIO_AF_0(GPIOC_PC2_MOTOR2_L1) | \
                                     PIN_AFIO_AF_0(GPIOC_PC3_MOTOR2_L2) | \
                                     PIN_AFIO_AF_3(GPIOC_PC4_MOTOR2_H2) | \
                                     PIN_AFIO_AF_3(GPIOC_PC5_MOTOR2_H1) | \
...
#define VAL_GPIOC_AFRH              (PIN_AFIO_AF_0(GPIOC_PC8_NC) | \
                                     ...
                                     PIN_AFIO_AF_2(GPIOC_PC10_MOTOR1_H1) | \
                                     PIN_AFIO_AF_2(GPIOC_PC11_MOTOR1_H2) | \
                                     PIN_AFIO_AF_0(GPIOC_PC12_NC) | \
                                     PIN_AFIO_AF_0(GPIOC_PC13_NC) | \
 ...
 */
#define VAL_GPIOD_AFRL              (PIN_AFIO_AF_0(GPIOD_PD0_NC) | \
                                     PIN_AFIO_AF_0(GPIOD_PD1_NC) | \
                                     PIN_AFIO_AF_0(GPIOD_PD2_NC) | \
                                     PIN_AFIO_AF_0(GPIOD_PD3_NC) | \
                                     PIN_AFIO_AF_0(GPIOD_PD4_NC) | \
                                     PIN_AFIO_AF_0(GPIOD_PD5_NC) | \
                                     PIN_AFIO_AF_0(GPIOD_PD6_NC) | \
                                     PIN_AFIO_AF_0(GPIOD_PD7_NC))
#define VAL_GPIOD_AFRH              (PIN_AFIO_AF_0(GPIOD_PD8_NC) | \
                                     PIN_AFIO_AF_0(GPIOD_PD9_NC) | \
                                     PIN_AFIO_AF_0(GPIOD_PD10_NC) | \
                                     PIN_AFIO_AF_0(GPIOD_PD11_NC) | \
...
#define VAL_GPIOE_AFRH              (PIN_AFIO_AF_0(GPIOE_PE8_NC) | \
                                     PIN_AFIO_AF_0(GPIOE_PE9_NC) | \
                                     PIN_AFIO_AF_0(GPIOE_PE10_NC) | \
                                     PIN_AFIO_AF_0(GPIOE_PE11_NC) | \
                                     PIN_AFIO_AF_0(GPIOE_PE12_NC) | \
                                     PIN_AFIO_AF_0(GPIOE_PE13_NC) | \
                                     PIN_AFIO_AF_0(GPIOE_PE14_NC) | \
                                     PIN_AFIO_AF_0(GPIOE_PE15_NC))
 ...
 */
#define VAL_GPIOH_AFRL              (PIN_AFIO_AF_0(GPIOH_PH0_NC) | \
